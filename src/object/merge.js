...
const merge: Function = (target: any, source: any, optionsArgument: Object): Object | Array<any> => {
...
export const all: Function = (array: Array<any>, optionsArgument: Object): Object | Array<any> => {
	if (!is.array(array)) {
...
function objectsMerge(target: any, source: any, optionsArgument: Object): Object {
	let destination = {};
