...
export const wrappedMixinRef = symbols.get('_wrappedMixin');

// used by apply() and isApplicationOf()
export const appliedMixinRef = symbols.get('_appliedMixin');
 ...
 */
export const unwrap = (wrapper) => wrapper[wrappedMixinRef] || wrapper;
