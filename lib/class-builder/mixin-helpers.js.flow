...
const wrappedMixinSymbol: Symbol = Symbol('wrappedMixin');

// used by apply() and isApplicationOf()
const appliedMixinSymbol: Symbol = Symbol('appliedMixin');
 ...
 */
export const unwrapMixin: Function = (wrapper: Function): Function => wrapper[wrappedMixinSymbol] || wrapper;
 ...
 * chain
 */
export const hasMixin: Function = (o: Object, mixin: Function): boolean => {
	while (o !== null) {
